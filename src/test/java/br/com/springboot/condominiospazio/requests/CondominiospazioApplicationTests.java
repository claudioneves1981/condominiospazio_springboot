package br.com.springboot.condominiospazio.requests;
...
public class CondominiospazioApplicationTests {
    @ClassRule
    ...
    public static void setUpClass() {
        TestWatchman.watchman.registerClass(CondominiospazioApplicationTests.class);
    }

    @AfterClass
    public static void tearDownClass() {
        TestWatchman.watchman.createReport(CondominiospazioApplicationTests.class);
    }
